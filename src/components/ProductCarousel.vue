...
const vinyls = [
  {name:"Magna - LP", artist:"Aphaca", src:"/aphaca.jpg", key:"vinyl-1", price:"219,95 DKK"},
  ...
  {name:"Rasmus Seebach - LP (Grå vinyl)", artist:"Rasmus Seebach", src:"/rasmus.jpg", key:"vinyl-4", price:"219,95 DKK"},
  ...
  {name:"Imaginal Disk (Indie Exclusive Edition) - 2LP (Hvid Vinyl)", artist:"Magdalena Bay", src:"/magdalenabay.jpg", key:"vinyl-6", price:"679,95 DKK"}
]
