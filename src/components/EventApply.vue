...
<template>
    <div class="apply">
        ...
        <h1>Sådan tilmelder dig du events</h1>
        
        <div class="first__step">
            <div>
                <img src="/public/stepOneRing.png" alt="første step med ring om 'Event' fanen">
            </div>
            <div>
                <h2>Step 1. Find 'Events' siden</h2>
                <p>Første step er at navigere til menubaren øverst på siden. Til højre findes siden 'Events', her klikker du ind.</p>
            </div>
        </div>

        <div class="second__step">
            <div>
                <img src="/public/stepTwoRing.png" alt="andet step med ring om 'Påmind mig'">
            </div>
            <div>
